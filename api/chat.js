export default async function handler(req, res) {
  ...
  // Handle browser GET visit gracefully
  if (req.method === 'GET') {
...
- Help with: account balances, transfers, card services, branch locations, loan enquiries.
- Never share real account numbers — this is a demo.`,
...
- Mention: MIA, Souq Waqif, Pearl Qatar, Katara, desert safaris.`,
